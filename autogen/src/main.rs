...
static JSON_SCHEMA_FILE: &str = "../generated/.spacepls.schema.json";
...
fn logger_init() {
    // set the log level
    const LONG_ENV_FILTER_VAR_NAME: &str = "SPACEPLS_SCHEMA_LOG_LEVEL";
    const SHORT_ENV_FILTER_VAR_NAME: &str = "SP_SCHEMA_LOG_LEVEL";
