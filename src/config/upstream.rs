...
pub struct Upstream {
    ...
    #[serde(default, skip_serializing_if = "is_default")]
    /// Activating this enables SpacePls's HTTP caching, adhering to the [HTTP Caching RFC](https://tools.ietf.org/html/rfc7234), to enhance performance by minimizing redundant data fetches. Defaults to `false` if unspecified.
    ...
    #[serde(default, skip_serializing_if = "is_default")]
    /// The User-Agent header value to be used in HTTP requests. @default `SpacePls/1.0`
...
impl Upstream {
    ...
    pub fn get_user_agent(&self) -> String {
        self.user_agent
            .clone()
            .unwrap_or("SpacePls/1.0".to_string())
    }
